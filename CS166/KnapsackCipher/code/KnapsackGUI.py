...
# KnapsackGUI.py
# Frank Mock CS166 Extra Credit Project
#
...
#
# Currently (12/12/2016) this program is not complete
# and requires much more work to make it a polished,
# working program. However, the main feature (encrypt
# plaintext and decrypt ciphertext) is operational.
#
# KnapsackGUI is the entry class for this application
class KnapsackGUI:
    def __init__(self):
        window = Tk()
        window.title("KNAPSACK CIPHER")
