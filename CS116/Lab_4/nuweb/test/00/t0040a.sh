...
\NWtarget{nuweb?}{} $\langle\,${\it Insist on regular expression \hbox{\slshape\sffamily response\/}}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@expect {@\\
\mbox{}\verb@   timeout {@\\
...
\begin{list}{}{} \item
\mbox{}\verb@Stuff@\\
\mbox{}\verb@@\hbox{$\langle\,${\it Insist on regular expression \verb@@<Clear screen@>$name +$today@}\nobreak\ {\footnotesize \NWlink{nuweb?}{?}}$\,\rangle$}\verb@@\\
\mbox{}\verb@Nonsense@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
...
\NWtarget{nuweb?}{} $\langle\,${\it Clear screen}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
