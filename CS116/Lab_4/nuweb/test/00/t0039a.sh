...
\NWtarget{nuweb1b}{} $\langle\,${\it Fragment whatever}\nobreak\ {\footnotesize {1b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb1c}{} $\langle\,${\it Fragment with \hbox{\slshape\sffamily n\/} parameter \hbox{\slshape\sffamily things\/}}\nobreak\ {\footnotesize {1c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb1d}{} $\langle\,${\it Arguments}\nobreak\ {\footnotesize {1d}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
